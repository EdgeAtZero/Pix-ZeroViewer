...
abstract class BaseListAdapter<T : Any, VH : ViewHolder> : Adapter<T, VH>, Bridge<T> {
    ...
    override fun current(): List<T> = currentList

    override fun clone(): List<T> = currentList.toList()
    ...
    companion object {
        ...
        @JvmStatic
        protected inline fun <reified T : Any, reified Binding : ViewDataBinding> BaseListAdapter<T, DataBindingViewHolder<Binding>>.inflateHolder(
            container: ViewGroup? = view
