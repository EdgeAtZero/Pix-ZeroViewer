 ...
 */
class ProxyDrawable @JvmOverloads constructor(
    drawable: Drawable? = null,
    private val invalidateDelegate: InvalidateDelegate = InvalidateDelegate()
) : Drawable(), ResizeDrawable, Drawable.Callback by invalidateDelegate,
    InvalidateDrawable by invalidateDelegate {
    var drawable: Drawable = drawable?.also { it.callback = invalidateDelegate } ?: this
        set(drawable) {
            field.callback = null
