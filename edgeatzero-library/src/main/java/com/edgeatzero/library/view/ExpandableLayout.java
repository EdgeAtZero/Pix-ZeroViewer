...
//    public static int COLLAPSING = 1;
//    public static int EXPANDING = 2;
//    public static int EXPANDED = 3;
//
...
//            duration = a.getInt(R.styleable.ExpandableLayout_animationDuration, DEFAULT_DURATION);
