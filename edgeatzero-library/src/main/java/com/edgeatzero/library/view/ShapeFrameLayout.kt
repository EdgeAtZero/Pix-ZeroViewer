...
open class ShapeFrameLayout @JvmOverloads constructor(
    ...
    init {
        ...
        attr.getDimension(R.styleable.ShapeFrameLayout_radius, -1F).also {
            if (it == -1F) {
                radius.fill(
                    attr.getDimension(R.styleable.ShapeFrameLayout_radiusLeftTop, 0F),
                    0,
                    2
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeFrameLayout_radiusRightTop, 0F),
                    2,
                    4
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeFrameLayout_radiusRightBottom, 0F),
                    4,
                    6
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeFrameLayout_radiusLeftBottom, 0F),
                    6,
                    8
                )
            } else {
        ...
        circle = attr.getBoolean(R.styleable.ShapeFrameLayout_circle, false)
