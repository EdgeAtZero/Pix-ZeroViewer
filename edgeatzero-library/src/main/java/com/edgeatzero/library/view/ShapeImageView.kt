...
open class ShapeImageView @JvmOverloads constructor(
    ...
    init {
        ...
        attr.getDimension(R.styleable.ShapeImageView_radius, -1F).also {
            if (it == -1F) {
                radius.fill(
                    attr.getDimension(R.styleable.ShapeImageView_radiusLeftTop, 0F),
                    0,
                    2
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeImageView_radiusRightTop, 0F),
                    2,
                    4
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeImageView_radiusRightBottom, 0F),
                    4,
                    6
                )
                radius.fill(
                    attr.getDimension(R.styleable.ShapeImageView_radiusLeftBottom, 0F),
                    6,
                    8
                )
            } else {
        ...
        circle = attr.getBoolean(R.styleable.ShapeImageView_circle, false)
